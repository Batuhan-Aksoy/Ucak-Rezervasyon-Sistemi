...
CREATE TABLE `rezervasyon` (
  `rezid` int NOT NULL AUTO_INCREMENT,
  `userid` varchar(45) NOT NULL,
  `rez_byer` varchar(45) NOT NULL,
  `rez_gyer` varchar(45) NOT NULL,
  `rez_tarih` varchar(45) NOT NULL,
  `rez_sirket` varchar(45) NOT NULL,
  `rez_koltukno` int NOT NULL,
  PRIMARY KEY (`rezid`)
